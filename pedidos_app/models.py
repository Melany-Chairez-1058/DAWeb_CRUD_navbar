...
class Pedido(models.Model):
    ...
    id_cliente = models.PositiveSmallIntegerField(default=0)
    id_producto = models.PositiveSmallIntegerField(default=0)
    id_empleado= models.PositiveBigIntegerField(default=0)
